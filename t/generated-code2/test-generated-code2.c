...
#define DO_TEST_ONEOF(base_member, value, example_packed_data, assign, equal_func) \
  DO_TEST_GENERIC_ONEOF(Foo__TestMessOneof, \
                FOO__TEST_MESS_ONEOF__INIT, \
                foo__test_mess_oneof__free_unpacked, \
                TestOneof_case, \
                Foo__TestMessOneof__TestOneof_##base_member##_e, \
                TestOneof.base_member, \
                value, example_packed_data, assign, equal_func, CHECK_NONE)

#define DO_TEST_ONEOF_REF_VAL(base_member, value, example_packed_data, assign, equal_func) \
  DO_TEST_GENERIC_ONEOF(Foo__TestMessOneof, \
                FOO__TEST_MESS_ONEOF__INIT, \
                foo__test_mess_oneof__free_unpacked, \
                TestOneof_case, \
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_int32, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_sint32, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_sfixed32, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_int64, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_sint64, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_sfixed64, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_uint32, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_fixed32, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_uint64, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_fixed64, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_float, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_double, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_boolean, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_enum_small, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF(test_enum, value, example_packed_data, GENERIC_ASSIGN, NUMERIC_EQUALS)
...
{
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF_REF_VAL (test_string, value, example_packed_data, GENERIC_ASSIGN, STRING_EQUALS)
  DO_TEST ("", test_optional_string_empty);
  DO_TEST ("hello", test_optional_string_hello);
#undef DO_TEST
}
static void test_oneof_bytes (void)
{
  ...
  static ProtobufCBinaryData bd_random = { 5, (uint8_t*)"\1\0\375\2\4" };
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF (test_bytes, value, example_packed_data, GENERIC_ASSIGN, binary_data_equals)
  DO_TEST (bd_empty, test_optional_bytes_empty);
  DO_TEST (bd_hello, test_optional_bytes_hello);
  DO_TEST (bd_random, test_optional_bytes_random);
#undef DO_TEST
...
static void test_oneof_SubMess (void)
{
  Foo__SubMess submess = FOO__SUB_MESS__INIT;
#define DO_TEST(value, example_packed_data) \
  DO_TEST_ONEOF_REF_VAL (test_message, value, example_packed_data, GENERIC_ASSIGN, submesses_equals)
  submess.test = 0;
  DO_TEST (&submess, test_optional_submess_0);
  submess.test = 42;
  DO_TEST (&submess, test_optional_submess_42);
